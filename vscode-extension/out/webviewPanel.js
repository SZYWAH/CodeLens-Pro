...
class CodeLensWebviewPanel {
    ...
    createOrReveal() {
        ...
        this.panel = vscode.window.createWebviewPanel("codelensPro", "CodeLens Pro", vscode.ViewColumn.Beside, {
            enableScripts: true,
            retainContextWhenHidden: true,
            localResourceRoots: (0, webviewHtml_1.getWebviewResourceRoots)(this.context.extensionUri),
        });
        this.panel.webview.html = (0, webviewHtml_1.renderCodeLensHtml)(this.panel.webview, this.context.extensionUri, this.backend.apiBase);
...
exports.CodeLensWebviewPanel = CodeLensWebviewPanel;
