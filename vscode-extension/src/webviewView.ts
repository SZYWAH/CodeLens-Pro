...
export const CODELENS_VIEW_ID = "codelensPro.sidebar";
export const CODELENS_VIEW_CONTAINER_ID = "codelensProContainer";

export class CodeLensWebviewViewProvider implements vscode.WebviewViewProvider {
  ...
  async resolveWebviewView(webviewView: vscode.WebviewView) {
    ...
    webviewView.webview.html = renderCodeLensHtml(webviewView.webview, this.context.extensionUri, this.backend.apiBase);
  ...
  private async reveal() {
    await vscode.commands.executeCommand(`workbench.view.extension.${CODELENS_VIEW_CONTAINER_ID}`);
  }
